...
export const HeartMetrics = () => {
  return (
    <div className="grid grid-cols-1 gap-4">
      {/* Heart Beat Card */}
      <Card className="bg-[#F3FFE5] p-4 rounded-3xl h-[262px]">
      ...
      {/* Heart Score Card */}
      <Card className="bg-[#D3E4FD] p-4 rounded-3xl h-[172px]">
        <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <span className="inline-block bg-white text-gray-700 px-3 py-1 rounded-full text-sm">
              Very Healthy
            </span>
          </div>
        </div>
