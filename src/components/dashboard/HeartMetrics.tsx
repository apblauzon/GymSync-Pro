      ...
      <Card className="bg-[#F3FFE5] p-5 rounded-[25px] flex flex-col">
        ...
        <div className="flex flex-col flex-grow">
          <div className="flex items-baseline gap-2 mb-2">
            <span className="text-5xl font-bold text-[#FF6B6B]">110</span>
            <span className="text-gray-600 text-xl">bpm</span>
          </div>
          <span className="inline-block bg-[#E5FFB6] text-gray-700 px-3 py-1 rounded-full text-sm w-fit mb-2">
            Normal
          </span>
          <p className="text-base text-gray-600 mb-auto">
      ...
      <Card className="bg-[#D3E4FD] p-5 rounded-[25px]">
        <div className="flex justify-between items-center mb-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-semibold">Heart Score</h3>
          </div>
          <button className="text-gray-600 hover:text-gray-800">
            <MoreHorizontal className="w-5 h-5" />
          </button>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <span className="inline-block bg-white text-gray-700 px-4 py-1.5 rounded-full text-base font-medium shadow-sm">
              Very Healthy
            </span>
          </div>
        </div>
