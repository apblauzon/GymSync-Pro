      ...
      <Card className="bg-[#F3FFE5] p-5 rounded-[25px] flex flex-col">
        <div className="flex justify-between items-center mb-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-2xl font-semibold">Heart Beat</h3>
          </div>
      ...
      <Card className="bg-[#D3E4FD] p-5 rounded-[25px]">
        <div className="flex justify-between items-center mb-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-2xl font-semibold">Heart Score</h3>
          </div>
          <button className="text-gray-600 hover:text-gray-800">
            <MoreHorizontal className="w-5 h-5" />
          </button>
        ...
        <div className="flex items-center gap-4">
          <div className="bg-white p-3 rounded-2xl shadow-sm">
            <Heart className="w-14 h-14 text-[#FF6B6B] fill-[#FF6B6B]" />
          </div>
          <div>
            ...
            <span className="inline-block bg-white text-gray-700 px-4 py-1.5 rounded-full text-lg font-medium shadow-sm">
              Very Healthy
            </span>
          </div>
        </div>
